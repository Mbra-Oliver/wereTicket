...
// Point d'entrée Passenger (cPanel/CloudLinux)
// Objectif: avoir un boot *silencieux* mais traçable via startup.log
...
// Charge .env local (si présent) avant l'app
...
try {
  ...
  // IMPORTANT: module.exports doit être l'application Express directement
  module.exports = app;
} catch (e) {
