 ...
 */
namespace ElementskitVendor\Google\Http;

use ElementskitVendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use ElementskitVendor\Google\Client;
use ElementskitVendor\Google\Task\Runner;
use ElementskitVendor\Google\Service\Exception as GoogleServiceException;
use ElementskitVendor\GuzzleHttp\ClientInterface;
use ElementskitVendor\GuzzleHttp\Exception\RequestException;
use ElementskitVendor\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if ($response instanceof \ElementskitVendor\GuzzleHttp\Message\ResponseInterface) {
