 ...
 */
namespace ElementskitVendor\Google\Auth\Subscriber;

use ElementskitVendor\Google\Auth\FetchAuthTokenInterface;
use ElementskitVendor\Google\Auth\GetQuotaProjectInterface;
use ElementskitVendor\GuzzleHttp\Event\BeforeEvent;
use ElementskitVendor\GuzzleHttp\Event\RequestEvents;
use ElementskitVendor\GuzzleHttp\Event\SubscriberInterface;
/**
