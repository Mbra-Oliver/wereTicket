...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <form action="{{ route('admin.payment_gateways.update_cinetpay_info') }}" method="post">
                    @csrf
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-title">{{ __('Cinetpay') }}</div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="cinetpay_status" value="1"
                                                class="selectgroup-input" {{ $cinetpay->status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="cinetpay_status" value="0"
                                                class="selectgroup-input" {{ $cinetpay->status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('cinetpay_status'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('cinetpay_status') }}</p>
                                    @endif
                                </div>

                                @php $cinetpayInfo = json_decode($cinetpay->information, true); @endphp

                                <div class="form-group">
                                    <label>{{ __('Site Id') }}</label>
                                    <input type="text" class="form-control" name="cinetpay_site_id"
                                        value="{{ $cinetpayInfo['site_id'] }}">
                                    @if ($errors->has('cinetpay_site_id'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('cinetpay_site_id') }}</p>
                                    @endif
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Cinetpay Api Key') }}</label>
                                    <input type="text" class="form-control" name="cinetpay_api_key"
                                        value="{{ $cinetpayInfo['api_key'] }}">
                                    @if ($errors->has('cinetpay_api_key'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('cinetpay_api_key') }}</p>
                                    @endif
                                </div>


                                <div class="form-group">
                                    <label>{{ __('Cinetpay Secret Key') }}</label>
                                    <input type="text" class="form-control" name="cinetpay_secret_key"
                                        value="{{ $cinetpayInfo['secret_key'] }}">
                                    @if ($errors->has('cinetpay_secret_key'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('cinetpay_secret_key') }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
